...
# R495 (2026-09-18): CKPT_NAME selects another checkpoint directory under /srv/qwen5090/models (the served model id follows it),
# e.g. CKPT_NAME=qwen3.8-flash-next-exl3-2.50bpw-r0b0tlab. Default = the served 3.05bpw.
CKPT_NAME=${CKPT_NAME:-qwen3.8-flash-next-exl3-3.05bpw}
