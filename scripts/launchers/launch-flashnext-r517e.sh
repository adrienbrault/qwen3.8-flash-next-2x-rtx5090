#!/usr/bin/env bash
# R517 (2026-09-19): R511 (no decode r4 flags; used only if R514 did not promote) + E3 grouped MoE prefill round 2 (R513: cold prefill +16 / +21 / +19 % at 30k / 60k / 120k, decode
...
# fingerprint becomes 4a255910dee2d9c5 (E3's prefill accumulation order). ROLLBACK: launch-flashnext-r511.sh.
...
CACHE=${CACHE:-786432}   # R511: 2.50bpw daily (3.05bpw: 360448)
...
EXTRA_ENV=${EXTRA_ENV:-EXL3_HOST_GAP_REWIND=1 EXL3_HC_MIX_V2=1 EXL3_HC_MIX_V2_MIN_R=1 EXL3_LS_PREFILL_PIPELINE=1 EXL3_MOE_COOP_V2=1 EXL3_SHARED_EXPERT_OVERLAP=1 EXL3_MOE_PREFILL_E3=1}
EV=()
