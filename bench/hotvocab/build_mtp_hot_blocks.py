...
def main(args, parser):
    ...
    if config.vocab_size % GROUP_SIZE:
        parser.error("Model vocabulary must contain complete 128-token groups")
    if args.blocks * BLOCK_SIZE > config.vocab_size:
        parser.error("--blocks exceeds the model vocabulary")
