...
class AsyncGenerator:
    ...
    async def close(self):
        ...
        # NVMe tier (EXL3_NVME_TIER): finish queued writes and release the directory lock before a reload
        if getattr(self.generator, "disk_page_cache", None) is not None:
            self.generator.disk_page_cache.close()
