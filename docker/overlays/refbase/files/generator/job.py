...
from .draft_overlap import draw_sampling_seed
    ...
    def prefill(self, results: list):
        ...
        for seq in self.sequences:
            ...
            if prefill_end > prefill_start:
                ...
                if os.environ.get("EXL3_PREFILL_NOSYNC", "0") == "1":
                    # Explicit prefill marker: decode/verification never receives it.
                    params["_prefill_nosync"] = True
                if getattr(self, "_ls_prefill_pipeline", None) is not None:
                    self._ls_prefill_pipeline.forward(prefill_ids, params)
