...
from common.metrics import record_completion
...
def log_metrics(
    ...
    # Feed the Prometheus registry. This is the per-completion metrics hook;
    # record_completion swallows its own failures.
    record_completion(label, metrics, context_len, max_seq_len)
