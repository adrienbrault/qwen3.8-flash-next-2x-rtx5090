#!/usr/bin/env python3
"""
Install the metrics-r1 overlay into a TabbyAPI tree (default /app).
...
def main():
    ...
    if errors:
        ...
        print("metrics-r1 overlay NOT installed: baseline verification failed", file=sys.stderr)
        return 1
    ...
    print(f"metrics-r1 overlay verified: {len(manifest['files'])} files under {args.root}")
    return 0
