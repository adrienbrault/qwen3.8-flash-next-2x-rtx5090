...
#include "quant/exl3_moe_prefill_e3.cuh"
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
    ...
    m.def("gr_mix_v2", &gr_mix_v2, "gr_mix_v2");
    m.def("gr_mix_v2_int8", &gr_mix_v2_int8, "gr_mix_v2_int8");
    m.def("gr_mix_v2_fused", &gr_mix_v2_fused, "gr_mix_v2_fused");
    m.attr("hc_mix_v2_revision") = 2;
    ...
    m.def("exl3_moe_prefill_e3", &exl3_moe_prefill_e3, "exl3_moe_prefill_e3");
    m.def("exl3_moe_prefill_e3_tile_rows", &exl3_moe_prefill_e3_tile_rows, "exl3_moe_prefill_e3_tile_rows");
    m.def("exl3_moe_prefill_e3_det", &exl3_moe_prefill_e3_det, "exl3_moe_prefill_e3_det");
    m.def("exl3_moe_prefill_e3_det_reduce", &exl3_moe_prefill_e3_det_reduce, "exl3_moe_prefill_e3_det_reduce");
