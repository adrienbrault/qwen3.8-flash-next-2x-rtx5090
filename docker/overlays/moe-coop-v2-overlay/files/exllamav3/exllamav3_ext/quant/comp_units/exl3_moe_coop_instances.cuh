...
#define EXL3_MOE_COOP_INST_DEF(K) \
    ...
    EXL3_MOE_COOP_V2_INST_DEF(K)

#include "../exl3_moe_coop_v2_kernel.cuh"

#define EXL3_MOE_COOP_V2_INST_DECL(K) \
    MoeCoopKernel exl3_moe_coop_v2_a_k##K(int cb, int Hi, bool wide, bool global); \
    MoeCoopKernel exl3_moe_coop_v2_b_k##K(int cb, bool wide, bool global);
EXL3_MOE_COOP_V2_INST_DECL(1)
EXL3_MOE_COOP_V2_INST_DECL(2)
EXL3_MOE_COOP_V2_INST_DECL(3)
EXL3_MOE_COOP_V2_INST_DECL(4)
EXL3_MOE_COOP_V2_INST_DECL(5)
EXL3_MOE_COOP_V2_INST_DECL(6)
EXL3_MOE_COOP_V2_INST_DECL(7)
EXL3_MOE_COOP_V2_INST_DECL(8)

#define EXL3_MOE_COOP_V2_INST_DEF(K) \
    MoeCoopKernel exl3_moe_coop_v2_a_k##K(int cb, int Hi, bool wide, bool global) \
    { \
        using namespace exl3_moe_coop_v2_ns; \
        const int smem = smem_a_v2<K>(Hi, global); \
        if (wide) switch (cb) \
        { \
            case 0: return { (void*) exl3_moe_coop_v2_ns::exl3_moe_coop_a_kernel<K, 0, true>, smem }; \
            case 1: return { (void*) exl3_moe_coop_v2_ns::exl3_moe_coop_a_kernel<K, 1, true>, smem }; \
            default: return { (void*) exl3_moe_coop_v2_ns::exl3_moe_coop_a_kernel<K, 2, true>, smem }; \
        } \
        switch (cb) \
        { \
            case 0: return { (void*) exl3_moe_coop_v2_ns::exl3_moe_coop_a_kernel<K, 0, false>, smem }; \
            case 1: return { (void*) exl3_moe_coop_v2_ns::exl3_moe_coop_a_kernel<K, 1, false>, smem }; \
            default: return { (void*) exl3_moe_coop_v2_ns::exl3_moe_coop_a_kernel<K, 2, false>, smem }; \
        } \
    } \
    MoeCoopKernel exl3_moe_coop_v2_b_k##K(int cb, bool wide, bool global) \
    { \
        using namespace exl3_moe_coop_v2_ns; \
        const int smem = smem_b_v2<K>(global); \
        if (wide) switch (cb) \
        { \
            case 0: return { (void*) exl3_moe_coop_v2_ns::exl3_moe_coop_b_kernel<K, 0, true>, smem }; \
            case 1: return { (void*) exl3_moe_coop_v2_ns::exl3_moe_coop_b_kernel<K, 1, true>, smem }; \
            default: return { (void*) exl3_moe_coop_v2_ns::exl3_moe_coop_b_kernel<K, 2, true>, smem }; \
        } \
        switch (cb) \
        { \
            case 0: return { (void*) exl3_moe_coop_v2_ns::exl3_moe_coop_b_kernel<K, 0, false>, smem }; \
            case 1: return { (void*) exl3_moe_coop_v2_ns::exl3_moe_coop_b_kernel<K, 1, false>, smem }; \
