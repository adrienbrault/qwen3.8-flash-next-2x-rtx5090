...
| GSM8K 5-shot, n=500, thinking on, no stop strings | 0.974 at 8 slots; 0.974 with bf16 GDN state; 0.976, 0.974, 0.972, 0.976, 0.974, 0.978, 0.970 and 0.974 on the eight configurations before it (byte-identical decode); 0.978 and 0.980 before them | 2026-09-19, [R561][r561], [R548][r548], [R546][r546], [R540][r540], [R535][r535], [R534][r534], [R530][r530], [R529][r529], [R528][r528], [R525][r525]; 2026-09-18, [R509][r509]; 2026-09-19, [R516][r516] |
| [tool-eval-bench][tool-eval], 69 scenarios × 4 | 88.2 ± 1.0 | 2026-09-19, [R561][r561]; 86.8 ± 2.6 on [R548][r548], 86.5 ± 2.4 on [R546][r546], 87.2 ± 1.5 on [R540][r540], 85.0 ± 0.8 on [R535][r535], 87.0 ± 1.2 on [R534][r534], 84.8 ± 1.3 on [R530][r530] and 88.0 ± 1.6 on [R529][r529], where `tool_choice` enforcement turned TC-45 from 0 to 2 points on every trial (worth 2.9 points of the score). The ± is the spread of 4 trials on one boot; the last twelve configurations read 84.5 to 88.2, and the R529–R530 gap sits in scenarios that already change between trials of one boot ([R530][r530]) |
...
- R563: the served stack ported onto upstream ExLlamaV3 `dev` (`1d64111`), A/B against the served image at 8 slots: paired decode on 48 prompts, prefill, free VRAM, and upstream's fused shared-expert launch in place of our side-stream overlap.
- R559: the per-layer n-gram embedding rows prefetched from disk on a side stream (the table stays on NVMe).
...
- Kernel rounds: the cooperative MoE decode kernels for 17–32 verify rows (the path that would let 5–8 streams draft 2–3 tokens), one fused hyper-connection mixer kernel per site, and fused GDN decode kernels ([R562][r562] counts about 1,570 kernel launches per 8-stream step, averaging 11.4 µs).
